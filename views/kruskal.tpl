<!DOCTYPE html>
	...
	<!-- форма дл€ ввода вершин и ребер -->
		<form >
			<p align = center><label>Enter the number of edges</label></p>
			<!-- ввод количества ребер -->
			<p align = center><input class="matrix_size" type="number" name="setOfEdges" id="setOfEdgesId" value = "{{sizeEdges}}"	min="1"></p>
			<p align = center><label>Enter the number of vertices</label></p>
			<!-- ввод количества вершин -->
			<p align = center><input class="matrix_size" type="number" name="setOfVertice" id="verticId" value = "{{sizeVertic}}"		min="2"></p>
			<!-- кнопка дл€ отправки формы -->
			<p><button style="margin: 10px 0px 5%" class="button button1 hh2" type="submit">Create</button></p>
		</form>
		...
		<table align = center cellspacing="3" border="1" cellpadding="5">
			<tr>
				...
				<tr>
				<td align = center><input class = "cell" type="number" name="startingVertex" value = "0" min = "1" max = "{{sizeVertic}}" required></td>
				<td align = center><input class = "cell" type="number" name="finalVertex"  value = "0" min = "1" max = "{{sizeVertic}}" required></td>
				<td align = center><input class = "cell" type="number" name="ribWeight" value = "0" min = "1" required>
				<br name="row0"></td>
			    </tr>
				%end
			</table>
		...
		<!-- кнопка дл€ отправки формы -->
		<p><button style="margin: 10px 0px 5%" class="button button1 hh2" type="submit">Send</button></p>
		</form>
